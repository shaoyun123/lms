...
<link rel="stylesheet" href="${ctx}/static/cropper.css" />
    ...
    <script>
      $('#lms_dashboardPannel').on('click', 'a.link', function(){
        let name = $(this).attr('name');
        //syncStatus
        let syncStatus = $(this).attr('syncStatus');
        let searchType = $(this).attr('searchType');
        let time = $(this).attr('time');
        let sevenTime = $(this).attr('sevenTime');
        let ebayVersion = $(this).attr('ebayVersion');
        let status = $(this).attr('status');
        window.parent.postMessage({ name:name, syncStatus: syncStatus|| '', searchType: searchType || '', time: time || '',sevenTime: sevenTime || '', ebayVersion: ebayVersion || '', status: status},'*');
    });
    
    // 采购超时未处理 页面跳转
    $('#purchaseTimeoutNumber').on('click', 'a.purchaseLink', function(){
        let name = $(this).attr('name')
        let ifManager = $(this).attr('ifManager')
        let params = {}
        if (name === 'commodityprocessoutofstock') { // 缺货
            let isSale = $(this).attr('isSale')
            let findSupplyType = $(this).attr('findSupplyType')
            let expectedArrivalTimeType = $(this).attr('expectedArrivalTimeType')
            params = { name, ifManager, isSale, findSupplyType, expectedArrivalTimeType }
        }
        if (name === 'purchasespurchasespurchaseOrder') { // 不需要物流
            let order = $(this).attr('order')
            let searchOrderNoType = $(this).attr('searchOrderNoType')
            params = { name, ifManager, order, searchOrderNoType }
        }
        if (name === 'purchasespurchasesloweringNotice') { // 降价通知
            let isSale = $(this).attr('isSale')
            params = { name, ifManager, isSale }
        }
        if (name === 'warehouseprocessfeedback') { // 包装费
            let issueType = $(this).attr('issueType')
            let isHandle = $(this).attr('isHandle')
            let isSale = $(this).attr('isSale')
            params = { name, ifManager, issueType, isHandle, isSale }
        }
...
<%--    })--%>
    ...
    <div class="layui-fluid">
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12" id="lms_dashboardPannel">
                <div class="layui-row layui-col-space15">
                                    ...
                                    <div carousel-item>
                                        <ul class="layui-row layui-col-space10">
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="commodityprocessoutofstock" class="link">
                                                    <i class="layui-icon layui-icon-website"></i>
                                                    <cite>缺货流程</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="commoditytemplateproducttpl" class="link">
                                                    <i class="layui-icon layui-icon-find-fill"></i>
                                                    <cite>基础模板</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a  href="javascript:void(0);" name="commodityproductproductlist" class="link">
                                                    <i class="layui-icon layui-icon-loading-2"></i>
                                                    <cite>商品列表</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a  href="javascript:void(0);" name="workdevelopnewdevelop" class="link">
                                                    <i class="layui-icon layui-icon-home"></i>
                                                    <cite>新品开发</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="shopeeoperatetaskcenter" class="link">
                                            ...
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="eBayoperationpayments" class="link">
                                                    <i class="layui-icon layui-icon-tree"></i>
                                                    <cite>eBay Payments</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="purchasepurchasecancelorder" class="link">
                                        ...
                                        <ul class="layui-row layui-col-space10">
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="multiplatformprodshopeeprod" class="link">
                                                    <i class="layui-icon layui-icon-survey"></i>
                                                    <cite>Shopee商品</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="multiplatformdelivershipmentplan" class="link">
                                                    <i class="layui-icon layui-icon-survey"></i>
                                                    <cite>货件计划</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                               <a href="javascript:void(0);" name="multiplatformdeliverdistributepackage" class="link">
                                                    <i class="layui-icon layui-icon-survey"></i>
                                                    <cite>配货包装</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="multiplatformdelivershipmentaccess" class="link">
                                                    <i class="layui-icon layui-icon-survey"></i>
                                                    <cite>货件存取</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="multiplatformconfigframemanage" class="link">
                                                    <i class="layui-icon layui-icon-survey"></i>
                                                    <cite>框号管理</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="multiplatformconfigaddress" class="link">
                                                    <i class="layui-icon layui-icon-survey"></i>
                                                    <cite>收货地址</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="configurationstorejoomAccount" class="link">
                                                    <i class="layui-icon layui-icon-cart-simple"></i>
                                                    <cite>joom店铺</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a href="javascript:void(0);" name="fbaproductInfofbaselection" class="link">
                                                    <i class="layui-icon layui-icon-cart-simple"></i>
                                                    <cite>FBA选品管理</cite>
                                                </a>
                                            </li>
                        ...
                        <div class="layui-card">
                            ...
                            <div class="layui-card-body">
                                ...
                                <div class="layui-carousel layadmin-carousel layadmin-shortcut" id="smallTools" style="height: 280px;background-color: #fff;">
                                    <div carousel-item>
                                        <ul class="layui-row layui-col-space10" style="background-color: #fff;">
                                            <li class="layui-col-xs3">
                                                <a class="pointHand pointHandImg link" href="javascript:void(0);" name="virturltoolspacetransform">
                                                    <img src="${ctx}/static/img/wrapCommaConversionLogo.jpg"/>
                                                    <cite>换行逗号转换</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                            ...
                                            <li class="layui-col-xs3">
                                                <a class="pointHand pointHandImg" id="index1_customerServiceSearch">
                                                    <img src="${ctx}/static/img/saleCustomerSearchLogo.jpg"/>
                                                    <cite>销售客服查询</cite>
                                                </a>
                                            </li> -->
                                            <li class="layui-col-xs3">
                                            ...
                                            <!-- <li class="layui-col-xs3">
                                                <a  class="pointHand pointHandImg" id="index1_findSource">
                                                    <img src="${ctx}/static/img/findProductSourceLogo.jpg"/>
                                                    <cite>查找货源</cite>
                                                </a>
                                            </li> -->
                                            <li class="layui-col-xs3">
                                                <a class="pointHand pointHandImg link" href="javascript:void(0);" name="warehousecheckskucheck">
                                                    <img src="${ctx}/static/img/skuImgSearchLogo.jpg" />
                                                    <cite>SKU图片查询</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a class="pointHand pointHandImg link" href="javascript:void(0);" name="virturltoolsearchimg">
                                                    <img src="${ctx}/static/img/findImgByImgLogo.jpg" />
                                                    <cite>以图搜图</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                                <a class="pointHand pointHandImg link" href="javascript:void(0);" name="virturltoolmattingpic">
                                                    <img src="${ctx}/static/img/mattingLogo.jpg" />
                                                    <cite>抠图</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3" >
                                                <a class="pointHand pointHandImg link" href="javascript:void(0);" name="virturltoolcollectimg">
                                            ...
                                            <li class="layui-col-xs3">
                                                <a class="pointHand pointHandImg link" href="javascript:void(0);" name="virturltoolsetprice">
                                                    <img src="${ctx}/static/img/priceToolLogo.jpg" />
                                                    <cite>定价工具</cite>
                                                </a>
                                            </li>
                                            <li class="layui-col-xs3">
                                              <a class="pointHand pointHandImg link" href="javascript:void(0);" name="virturltoolmeitu">
                                                  <span style="display: inline-block;width: 100%;background: #F8F8F8;">
                                                      <img src="${ctx}/static/img/batchSearchImg.png" height="60">
                                                    </span>
                                                  <cite>美图秀秀</cite>
...
<%--                                        <a href="${imgHttpsAddress}/lms/package/epean-chrome-plugin.zip" target="_blank" lay-tips="信息采集插件，下载后解压缩，打开chrome扩展程序导入使用" style="color: blue;padding-left: 80px;"> 信息采集插件下载</a>--%>
                            ...
                            <div class="layui-card-body" style="height: 185px;overflow-y: auto;">
                                ...
                                <ul class="layui-row layui-col-space10" style="padding: 10px;">
                                    <li class="layui-col-xs2 disN">
                                        <a href="javascript:void(0);" name="configurationstorewishAccount" class="link" syncStatus="4">
                                            wish(<span id="index_wish_fail_num"></span>)
                                        </a>
                                    </li>
                                    <li class="layui-col-xs2 disN">
                                        <a href="javascript:void(0);" name="configurationstoreebayAccount" class="link" syncStatus="4">
                                            ebay(<span id="index_ebay_fail_num"></span>)
                                        </a>
                                    </li>
                                    <li class="layui-col-xs2 disN">
                                        <a href="javascript:void(0);" name="configurationstorealiexpressAccount" class="link" syncStatus="4">
                                            aliexpress(<span id="index_aliexpress_fail_num"></span>)
                                        </a>
                                    </li>
                                    <li class="layui-col-xs2 disN">
                                        <a href="javascript:void(0);" name="configurationstoreamazonAccount" class="link" syncStatus="4">
                                            amazon(<span id="index_amazon_fail_num"></span>)
                                        </a>
                                    </li>
                                    <li class="layui-col-xs2 disN">
                                        <a href="javascript:void(0);" name="configurestoreshopeeaccount" class="link" syncStatus="4">
                                            shopee(<span id="index_shopee_fail_num"></span>)
                                        </a>
                                    </li>
                                    <li class="layui-col-xs2 disN">
                                        <a href="javascript:void(0);" name="configurationstorejoomAccount" class="link" syncStatus="4">
                                            joom(<span id="index_joom_fail_num"></span>)
                                        </a>
                                    </li>
                                    <li class="layui-col-xs2 disN">
                                        <a href="javascript:void(0);" name="configurationstorelazadaAccount" class="link" syncStatus="4">
    ...
    <script type="text/html" id="index1_UCP_EANcreator">
        <div class="p20">
            <form action="" lay-filter="UCP_EANcreatorForm_index1" class="layui-form" id="UCP_EANcreatorForm_index1">
                <div class="layui-form-item ml20">
                    <div class="layui-col-md2 layui-col-lg2">
                        <select name="codeType" id="codeType" lay-filter="codeType" lay-search>
                    ...
                    <form id="storeAcctSalesPersonIdForm" class="layui-form" style="padding-right:20px;">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-col-md4">
                                ...
                                <div class="layui-input-block">
                                    <select id="storeStatus" name="storeStatus" lay-search>
    ...
    <%-- 空格逗号转换 --%>
    <script type="text/html" id="index1_spaceTransform_layer">
            ...
            <form class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="display:flex;align-items: center;">
                        <div>
                            <select name="transformOne" lay-search>
                                <option value="lineOne" selected>换行</option>
                                <option value="commaOne">逗号</option>
                                <option value="spaceOne">空格</option>
                            </select>
                        </div>
                        <div style="padding: 0 20px;"><a href="javascript:;" id="index1_spaceTransform_btn" style="color:#34a8fe;">转换</a></div>
                        <div>
                            <select name="transformTwo" lay-search>
    ...
    <script>
        ...
        */
        ...
        ;(function(){
                ...
                for(var i=0; i<result.length; i++){
                    ...
                    if(platCode != "lazada" && platCode !== 'aliexpress'){
                      ...
                      liStr+=`<li class="layui-col-xs2">
                          <a href="javascript:void(0);" name="configurationstore\${platCode}Account" class="link" searchType="2">
            ...
            let purchaseNameMap = {
                '缺货': 'commodityprocessoutofstock',
                '不需要物流': 'purchasespurchasespurchaseOrder',
                '降价通知': 'purchasespurchasesloweringNotice',
                '包装费': 'warehouseprocessfeedback'
            }

            let purchaseParamsMap = {
                // 缺货页面 条件 商品状态:在售 找供应商:无 有无预计到货时间：无
                '缺货': 'isSale="1" findSupplyType="0" expectedArrivalTimeType="0"',
                '不需要物流': 'order="不需要物流" searchOrderNoType="3"',
                '降价通知': 'isSale="1"',
                '包装费': 'issueType="单数套袋" isHandle="0" isSale="true"',
            }
            ...
            commonReturnPromise({
                ...
                result?.forEach(item => {
                    liStr+=`<li class="layui-col-xs2">
                        <a href="javascript:void(0);" class="purchaseLink" ifManager="\${item.ifManager}" name="\${purchaseNameMap[item.name]}" \${purchaseParamsMap[item.name]}>
