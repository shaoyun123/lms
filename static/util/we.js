!function (e, t) {
    ...
    f.prototype = {
        ...
        constructor: k, onClick: function () {
            ...
            var e = this, editor = this.editor, t = c("text-val"), n = c("btn"), A = c("upload_videoFile"), B = c("upload_videoBtn"), i = new f(this, {
                width: 350,
                tabs: [
                    {
                        title: "上传视频",
                        ...
                        events: [{
                            ...
                            selector: "#" + A, type: "change", fn: function () {
                                ...
                                var i = n.files;
                                console.log(i)
                                return i.length && editor.uploadVideo.uploadVideo(i), !0
                            }
                        }]
                    },{
                    title: "插入视频",
    ...
    Video.prototype = {
        ...
        uploadVideo: function (files) {
            var t = this, n = this.editor, i = n.config, f = i.uploadVideo
            if (f.uploadVideo && "function" == typeof f.uploadVideo) {
                f.uploadVideo(t._insert.bind(t), files, n);
            } else {
                alert('请选初始化上传视频方法')
            }
        }
    ...
    j.prototype = {
        constructor: j, _initConfig: function () {
            ...
            this.uploadVideo = new Video(this)
        }, _initMenus: function () {
