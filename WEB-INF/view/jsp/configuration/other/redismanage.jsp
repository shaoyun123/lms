...
<title>缓存管理（已弃用，目前使用的是redis.jsp）</title>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                        <form  class="layui-form" id="rm_searchForm_deprecated">
                            <div class="layui-inline">
                                <label for="" class="layui-fom-label">Key:</label>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <!-- 表格的数据渲染 -->
                    <table class="layui-table" id="rm_table_deprecated" lay-filter="rm_table_deprecated"></table>
...
<!--不同类型的弹出层-->
<script type="text/html" id="redismanage_hashLayer">
<div class="p20">
...
<script>
    ...
    layui.use(['admin', 'form', 'table','layer'], function() {
        ...
        //监听表格工具条事件
        table.on('tool(rm_table_deprecated)',function(obj){
            ...
            //编辑key
                ...
                if(data.type == "hash"){
                    layer.open({
                        type: 1,
                        content: $('#redismanage_hashLayer').html(),
                        shadowClose: true,
                        area: ['600px','400px'],
                        btn: ['确定','取消'],
							...
							$.ajax({
								...
								success:function(returnData){
									...
									for(var i=0; i<returnData.data.length; i++){
										var tpl = '<tr><td>:field</td><td><input name="value" type="text" class="layui-input" value=":value"></td><td><a id="rm_removeFieldBtn" class="layui-btn layui-btn-danger layui-btn-xs">X</a></td></tr>';
        ...
        $("#rm_searchBtn").on("click", function(){
        		var key = $("#rm_searchForm_deprecated input").val();
        		if(key != undefined && key != ""){
        			//执行重载
				table.reload('rm_table_deprecated', {
				   where: {key:key}
				});
        		}
        });
