        ...
        <div class="layui-col-md12">
          <div class="layui-card">
                <div class="layui-card-body">
                    <form id="amazonModifyTitleForm" class="layui-form">
                        <div class="layui-form-item" style="margin-bottom:0">
                            <div class="layui-col-lg1 layui-col-md1">
                                <select id="amazonModTitle_is_pAnds_sku" name="skuType">
                            ...
                            <div class="layui-col-md1 layui-col-lg1">
                                <select id="amazon_idEnable_skuSearchType" name="searchType">
                            ...
                            <div class="layui-col-lg2 layui-col-md2">
                                ...
                                <div class="layui-input-block">
                                    <select id="amazon_mt_depart_sel" lay-search lay-filter="amazon_mt_depart_sel"  class="orgs_hp_custom">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-col-lg2 layui-col-md2">
                                ...
                                <div class="layui-input-block">
                                    <select lay-search lay-filter="amazon_mt_salesman_sel"  class="users_hp_custom" data-rolelist="amazon专员" >
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-col-lg2 layui-col-md2">
                                ...
                                <div class="layui-input-block">
                                    <select xm-select="amazon_mt_store_sel" id="amazon_mt_store_sel"
                                            xm-select-search xm-select-search-type="dl" xm-select-skin="normal"
                                            lay-filter="amazon_mt_store_sel" class="store_hp_custom" data-platcode="amazon">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-col-lg2 layui-col-md2" style="text-align:right">
                                <button class="layui-btn layui-btn-sm keyHandle" type="button" data-type="reload" id="amazonModifyTitleSearchBtn">搜索</button>
                                <button type="reset" class="layui-btn layui-btn-primary layui-btn-sm" id="amazonModifyTitleResetBtn">清空</button>
                            </div>
                        </div>
                        <div id="amazonModTitleCustomsContent"></div>
                    </form>
            ...
            <div class="layui-card">
                ...
                <div class="dis_flex mg_10">
                        <button type="button" id="modifyStockButtn" class="layui-btn layui-btn-normal layui-btn-sm">批量修改</button>
                    </div>
                </div>
                <div class="layui-card-body">
                    <!-- 表格的数据渲染 -->
...
<script type="text/javascript" src="${ctx}/static/js/publishs/amazon/amazonModifyTitle.js"></script>
<script>
