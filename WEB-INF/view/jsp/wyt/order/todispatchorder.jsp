<%@ page language="java" import="java.util.*" contentType="text/html;charset=UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="permTag" uri="/WEB-INF/tld/permTag.tld" %>
            ...
            <style>
                ...
                .externalContaintoDispatchOrderWinit {
                    position: relative;
                    width: 0;
                    float: left;
                    height: 0;
                ...
                #LAY-toDispatchOrderWinit .layui-btn+.layui-btn{
    ...
    .errorTipsword{
        ...
        color:#A94748
            ...
            <div class="layui-fluid" id="LAY-toDispatchOrderWinit">
                <div class="layui-row layui-col-space15">
                    <div class="layui-col-lg12 layui-col-md12">
                        <div class="layui-card">
                            <div class="layui-card-body">
                                <form class="layui-form" id="toDispatchOrderWinitForm" lay-filter="toDispatchOrderWinitForm">
                                    <div class="layui-form-item">
                                        <div class="layui-col-md4 layui-col-lg4">
                                            <label class="layui-form-label">订单时间</label>
                                            <div class="layui-input-block">
                                                <input type="text" class="layui-input" id="toDispatchOrderWinit_time" name="time" lay-verify="required" readonly>
                                            </div>
                                        </div>
                                        <div class="layui-col-lg2 layui-col-md2">
                                            <label class="layui-form-label">平台</label>
                                            <div class="layui-input-block">
                                                <select name="platCode" lay-filter="todispacthplatCodes" lay-search>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="layui-col-lg4 layui-col-md4">
                                            ...
                                            <div class="layui-input-block">
                                                <select name="storeAcctIds" xm-select="storeAcct" xm-select-search xm-select-search-type="dl" xm-select-skin="normal" lay-filter="" lay-search>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="layui-col-lg2 layui-col-md2">
                                        ...
                                        <div class="layui-col-lg2 layui-col-md2">
                                            ...
                                            <div class="layui-input-block">
                                                <select name="platTags" xm-select="todispatchorderWinit_platTags" id="todispatchorderWinit_platTags" xm-select-search xm-select-search-type="dl" xm-select-skin="normal" lay-search>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="layui-col-lg2 layui-col-md2">
                                            <div class="layui-form-label" style="padding:0px 0px 0px 5px">
                                                <select name="companyType" lay-filter="todispacthcompanyType">
                                                    <option value="companys">物流公司</option>
                                                    <option value="agents">货代公司</option>
                                                </select>
                                            </div>
                                            <div class="layui-input-block">
                                                <select type="text" name="company" lay-filter="todispacthcompany" lay-search></select>
                                            </div>
                                        </div>
                                        <div class="layui-col-lg2 layui-col-md2 ">
                                            ...
                                            <div class="layui-input-block">
                                                <select name="logisTypeIds" 
                                                    ...
                                                    id="todispatchorder_logisTypeIds"
                                                    xm-select="todispatchorder_logisTypeIds" 
                                                    xm-select-search 
                                        ...
                                        <div class="layui-col-md2 layui-col-lg2 dis_flex_space">
                                            <div class="externalBox" id="showMoreSearchCondition_toDispatchOrderWinit">
                                                <span>更多查询条件<span class="hasValue"></span></span>
                                                <span id="hide_icon_toDispatchOrderWinit" class="fr mr10 hidden">︽</span>
                                                <span id="show_icon_toDispatchOrderWinit" class="fr mr10">︾</span>
                                            </div>
                                            <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" lay-submit="" id="toDispatchOrderWinitSearch" lay-filter="toDispatchOrderWinitSearch">查询</button>
                                        </div>
                                        <div class="externalContaintoDispatchOrderWinit disN">
                                        ...
                                        <div class="layui-col-md4 layui-col-lg4" id="toDispatchOrderWinit_storeSalesPersonDiv">
                                            <div class="layui-col-md6 layui-col-lg6">
                                                <label class="layui-form-label">店铺销售部门</label>
                                                <div class="layui-input-block">
                                                    <select name="salesPersonOrgId" lay-filter="toDispatchOrderWinit_orgFilter" class="orgs_hp_custom">
                                                        <option value=""></option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="layui-col-md6 layui-col-lg6">
                                                ...
                                                <div class="layui-input-block">
                                                    <select name="salesPersonId"  class="users_hp_custom" data-rolelist="ebay专员,wish专员,amazon专员,lazada专员,shopee专员" lay-filter="toDispatchOrderWinit_sellerFilter" lay-search="">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="layui-col-md4 layui-col-lg4" id="toDispatchOrderWinit_winitSalesPersonDiv">
                                            <div class="layui-col-md6 layui-col-lg6">
                                                <label class="layui-form-label">海外仓销售部门</label>
                                                <div class="layui-input-block">
                                                    <select name="winitSalesPersonOrgId" lay-filter="toDispatchOrderWinit_winitOrgFilter" class="orgs_hp_custom">
                                                        <option value=""></option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="layui-col-md6 layui-col-lg6">
                                                ...
                                                <div class="layui-input-block">
                                                    <select name="winitSalesPersonId"  class="users_hp_custom" data-rolelist="万邑通专员" lay-filter="toDispatchOrderWinit_winitSellerFilter" lay-search="">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <input class="hide" type="text" name="winitOrderProcessStatus" value="0">
                        ...
                        <div class="layui-card">
                            <div class="layui-card-body">
                                <div class="dis_flex_space">
                                    ...
                                    <div>
                                        <!--下拉按钮-->
                                        <permTag:perm funcCode="toDispatchOrderWinit_overseaOper">
                                        <div id="toDispatchOrderWinit_overseaOper" class="layui-inline">
                                            <button type="button" class="layui-btn layui-btn-normal layui-btn-sm">海外仓</button>
                                            <ul class="hidden">
                                                <li>
                                                    <div>海外仓</div>
                                                    <ul>
                                                        <permTag:perm funcCode="toDispatchOrderWinit_towinit"><li id="toDispatchOrderWinit_towinit">提交订单</li></permTag:perm>
                                                        <permTag:lacksPerm funcCode="toDispatchOrderWinit_towinit"><li class="disabledLi" disabled>提交订单</li></permTag:lacksPerm>
                                                        <permTag:perm funcCode="toDispatchOrderWinit_syncwinittrackno"><li id="toDispatchOrderWinit_syncwinittrackno">获取跟踪号</li></permTag:perm>
                                                        <permTag:lacksPerm funcCode="toDispatchOrderWinit_syncwinittrackno"><li class="disabledLi" disabled>获取跟踪号</li></permTag:lacksPerm>
                                                        <permTag:perm funcCode="toDispatchOrderWinit_syncWinitOutOrderCalcFee"><li id="toDispatchOrderWinit_syncWinitOutOrderCalcFee">预估预估派送费</li></permTag:perm>
                                                        <permTag:lacksPerm funcCode="toDispatchOrderWinit_syncWinitOutOrderCalcFee"><li class="disabledLi" disabled>预估预估派送费</li></permTag:lacksPerm>
                                                        <permTag:perm funcCode="toDispatchOrderWinit_syncWinitOutOrderStatus"><li id="toDispatchOrderWinit_syncWinitOutOrderStatus">同步订单处理状态</li></permTag:perm>
                                                        <permTag:lacksPerm funcCode="toDispatchOrderWinit_syncWinitOutOrderStatus"><li class="disabledLi" disabled>同步订单处理状态</li></permTag:lacksPerm>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div>
                                        </permTag:perm>
                                        <permTag:perm funcCode="toDispatchOrderWinit_platOper">
                                        <div id="toDispatchOrderWinit_platOper" class="layui-inline">
                                            <button type="button" class="layui-btn layui-btn-normal layui-btn-sm">平台操作</button>
                                            <ul class="hidden">
                                                <li>
                                                    <div>后台取消</div>
                                                    <ul>
                                                        <permTag:perm funcCode="toDispatchOrderWinit_cancelOrderEbay"><li id="toDispatchOrderWinit_cancelOrderEbay">ebay取消</li></permTag:perm>
                                                        <permTag:lacksPerm funcCode="toDispatchOrderWinit_cancelOrderEbay"><li class="disabledLi" disabled>ebay取消</li></permTag:lacksPerm>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <div>其他操作</div>
                                                    <ul>
                                                        <permTag:perm funcCode="toDispatchOrderWinit_syncOrderStatus"><li id="toDispatchOrderWinit_syncOrderStatus">更新订单状态</li></permTag:perm>
                                                        <permTag:lacksPerm funcCode="toDispatchOrderWinit_syncOrderStatus"><li class="disabledLi" disabled>更新订单状态</li></permTag:lacksPerm>
                                                        <permTag:perm funcCode="toDispatchOrderWinit_markDelivery"><li id="toDispatchOrderWinit_markDelivery">标记平台发货</li></permTag:perm>
                                                        <permTag:lacksPerm funcCode="toDispatchOrderWinit_markDelivery"><li class="disabledLi" disabled>标记平台发货</li></permTag:lacksPerm>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div>
                                        </permTag:perm>
                                        <permTag:perm funcCode="toDispatchOrderWinit_logis">
                                        <div id="toDispatchOrderWinit_logis" class="layui-inline">
                                            <button type="button" class="layui-btn layui-btn-normal layui-btn-sm">物流</button>
                                            <ul class="hidden">
                                                <permTag:perm funcCode="toDispatchOrderWinit_matchLogis"><li id="toDispatchOrderWinit_matchLogis">匹配物流</li></permTag:perm>
                                                <permTag:lacksPerm funcCode="toDispatchOrderWinit_matchLogis"><li class="disabledLi" disabled>匹配物流</li></permTag:lacksPerm>
                                                <permTag:perm funcCode="toDispatchOrderWinit_updatelogistype"><li id="toDispatchOrderWinit_updatelogistype">手动指定物流</li></permTag:perm>
                                                <permTag:lacksPerm funcCode="toDispatchOrderWinit_updatelogistype"><li class="disabledLi" disabled>手动指定物流</li></permTag:lacksPerm>
                                            </ul>
                                        </div>
                                        </permTag:perm>
                                        <permTag:perm funcCode="toDispatchOrderWinit_dealOrder">
                                        <div id="toDispatchOrderWinit_dealOrder" class="layui-inline">
                                            <button type="button" class="layui-btn layui-btn-normal layui-btn-sm">订单处理</button>
                                            <ul class="hidden">
                                                <permTag:perm funcCode="toDispatchOrderWinit_toAudit"><li id="toDispatchOrderWinit_toAudit">转待审核</li></permTag:perm>
                                                <permTag:lacksPerm funcCode="toDispatchOrderWinit_toAudit"><li class="disabledLi" disabled>转待审核</li></permTag:lacksPerm>
                                                <permTag:perm funcCode="toDispatchOrderWinit_markException"><li id="toDispatchOrderWinit_markException">标记异常</li></permTag:perm>
                                                <permTag:lacksPerm funcCode="toDispatchOrderWinit_markException"><li class="disabledLi" disabled>标记异常</li></permTag:lacksPerm>
                                                <permTag:perm funcCode="toDispatchOrderWinit_toCancel"><li id="toDispatchOrderWinit_toCancel">取消订单</li></permTag:perm>
                                                <permTag:lacksPerm funcCode="toDispatchOrderWinit_toCancel"><li class="disabledLi" disabled>取消订单</li></permTag:lacksPerm>
                                                <permTag:perm funcCode="toDispatchOrderWinit_toShipped"><li id="toDispatchOrderWinit_toShipped">直接转已发货</li></permTag:perm>
                                                <permTag:lacksPerm funcCode="toDispatchOrderWinit_toShipped"><li class="disabledLi" disabled>直接转已发货</li></permTag:lacksPerm>
                                            </ul>
                                        </div>
                                        </permTag:perm>
                                    </div>
                                </div>
                                <div class="layui-tab" lay-filter="toDispatchOrderWinit_tab" id="toDispatchOrderWinit_tab">
                                    <div class="">
                                    ...
                                    <div class="layui-tab-content">
                                        <table lay-filter="toDispatchOrderWinit_table" class="layui-table" id="toDispatchOrderWinit_table"></table>
                                        <div class="pageSortfix" id="toDispatchOrderWinitPage"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- 表格渲染模板 -->
            <script type="text/html" id="toDispatchOrderWinit_id_tpl">
                <input type="hidden" class="toDispatchOrderWinit_col_id" value="{{d.id}}">
                <div>
                    <span>{{d.id||""}}</span>
            ...
            <script type="text/html" id="toDispatchOrderWinit_label_tpl">
            ...
            <script type="text/html" id="toDispatchOrderWinit_platOrderAmt_tpl">
                ...
                {{# if(d.winitOrderProcessStatus==2&&d.winitOrderProcessRemark){ }}
                <div class="errorTips dis_flex"><div class="errorTipsword">{{d.winitOrderProcessRemark}}</div><div class="errorTipsClose">x</div></div>
                {{# } }}
            </script>

            <script type="text/html" id="toDispatchOrderWinit_prodQuantity_tpl">
            ...
            <script type="text/html" id="toDispatchOrderWinit_platOrderStatus_tpl">
                <!-- {{d.buyerNote||""}} -->
                {{# if(d.buyerNote){ }}
            ...
            <script type="text/html" id="toDispatchOrderWinit_shippingUsername_tpl">
            ...
            <script type="text/html" id="toDispatchOrderWinit_logisTypeName_tpl">
            ...
            <script type="text/html" id="toDispatchOrderWinit_time_tpl">
            ...
            <script type="text/html" id="toDispatchOrderWinit_option_tpl">
                <button class="layui-btn layui-btn-xs mtb" lay-event="checkDetail">查看详情</button>
                <br>
                <permTag:perm funcCode="orderWinit_sendEmail">
                <button class="layui-btn layui-btn-xs mtb" lay-event="toDispatchOrderWinit_sendEmail">发送邮件</button>
                <br>
                </permTag:perm>
                <permTag:perm funcCode="toAuditorderWinit_issueRefund">
                    <button class="layui-btn layui-btn-xs mtb" lay-event="toDispatchOrderWinit_issueRefund">eBay退款</button>
                    <br>
                </permTag:perm>
                <span class="layui-btn layui-btn-xs" lay-event="toDispatchOrderWinit_remark">订单备注</span>
            </script>
            <script type="text/html" id="toDispatchOrderWinit_cancelEbayTpl">
                <form class="layui-form" action="" lay-filter="component-form-group" id="toDispatchOrderWinit_cancelEbayForm">
                    <div class="p20">
                        <div class="layui-form-item">
            ...
            <script type="text/html" id="toDispatchOrderWinit_cancelWishpostTpl">
                <form class="layui-form" action="" lay-filter="component-form-group" id="toDispatchOrderWinit_cancelWishpostForm">
                    <div class="p20">
                        <div class="layui-form-item">
                            <label class="layui-form-label">取消原因</label>
                            <div class="layui-input-block">
            ...
            <script type="text/html" id="toDispatchOrderWinit_updateLogisTypeTpl">
                <form class="layui-form" action="" lay-filter="component-form-group" id="toDispatchOrderWinit_updateLogisTypeForm">
                    <div class="p20">
                        <div class="layui-form-item">
                            <label class="layui-form-label">物流公司</label>
                            <div class="layui-input-block">
                                <select class="layui-select" lay-search name="logisCompany" lay-filter="toDispatchOrderWinit_logisCompany">
                                    <option></option>
                                </select>
                            </div>
                        </div>
            ...
            <script type="text/html" id="todispatchWinit_detail_img_tpl">
                <div>
            ...
            <!-- 商品详情 -->
            <script type="text/html" id="pop_todispathorderWinit_detail">
                <div class="mg_50">
                    <table class="layui-table" id="pop_todispathorderWinit_detail_table" lay-filter="pop_todispathorderWinit_detail_table"></table>
                </div>
            </script>

            <!-- 修改/新增订单 -->
            <script type="text/html" id="pop_todispatchorder_newandeditorder">
                <div class="mg_50">
                    <div class="layui-tab" lay-filter="orderLog">
                        ...
                        <div class="layui-tab-content">
                          <div class="layui-tab-item layui-show">
                            <form class="layui-form" id="todispatchorder_editForm" lay-filter="todispatchorder_editForm">
                                <div class="layui-form-item">
                                    <div class="layui-col-md2 layui-col-lg2">
                                        <label class="layui-form-label">订单编号</label>
                                        <div class="layui-input-block">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-col-lg12 layui-col-md12 ">
                                        <table class="layui-table" id="todispatchorder_product_table" lay-filter="todispatchorder_product_table"></table>
                                    </div>
                                </div>
                                <permTag:perm funcCode="todispatchorderwinit:modifyaddress">
            ...
            <script type="text/html" id="todispatch_detail_img_tpl">
                <div>
                    <img width="60" height="60" data-original="{{d.imageUrl||''}}" class="img_show_hide b1 lazy" data-onerror="layui.admin.img_noFind()">
                </div>
            </script>
...
<!-- 表格渲染模板 -->
 ...
 <!-- 添加备注 -->
<script type="text/html" id="todispatchorderwinit_remark">
    <div class="layui-tab" id="todispatchorderwinitremarkTab">
        <ul class="layui-tab-title">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
            <form class="layui-form mg_50" lay-filter="todispatchorderwinitremarkForm" id="todispatchorderwinitremarkForm">
                <div class="layui-form-item">
                ...
                <button type="button" id="todispatchorderwinit_remark_submit" class="hidden" lay-submit lay-filter="todispatchorderwinit_remark_submit"></button>
            </form>
            </div>
            <div class="layui-tab-item">
            <form class="layui-form mg_50" lay-filter="todispatchorderwinitlabelForm" id="todispatchorderwinitlabelForm">
                <div class="layui-form-item">
                    <label class="layui-form-label">订单标签</label>
                    <div class="layui-input-block">
                ...
                <button type="button" id="todispatchorderwinit_label_submit" class="hidden" lay-submit lay-filter="todispatchorderwinit_label_submit"></button>
            </form>
            </div>
        </div>
        </div>
...
<script type="text/javascript" src="${ctx}/static/js/order/winit/todispatchorder.js"></script>
