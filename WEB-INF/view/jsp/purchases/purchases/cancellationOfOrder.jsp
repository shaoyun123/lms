        ...
        <div class="layui-col-lg12 layui-col-md12">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form" id="loweringNotice_form" method="post">
                        <div class="layui-form-item">
                            <div class="layui-col-md2 layui-col-lg2">
                                <label class="layui-form-label">采购专员</label>
                                <div class="layui-input-block">
                                    <select name="loweringNotice_buyerId" lay-search>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-col-md2 layui-col-lg2">
                                ...
                                <div class="layui-input-block">
                                    <select name="loweringNotice_integratorId" lay-search>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-col-md2 layui-col-lg2">
                                ...
                                <div class="layui-input-block">
                                    <select name="loweringNotice_developerId" lay-search>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-col-md2 layui-col-lg2">
                            ...
                            <div class="layui-col-md2 layui-col-lg2">
                                <div class="layui-input-block">
                                    <span class="layui-btn layui-btn-sm keyHandle" lay-submit lay-filter="loweringNotice_submit">查询</span>
...
<%-- 引入js文件 --%>
<script type="text/javascript" src="${ctx}/static/js/purchases/cancellationOfOrder.js"></script>