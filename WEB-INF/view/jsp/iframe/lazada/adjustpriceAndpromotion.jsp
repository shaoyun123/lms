...
<title>lazada调整原价和促销价</title>
<style>

</style>
<div class="layui-fluid" id="lay_lazadamodifyprice">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form id="lazadamodifypriceAndPromoForm" class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-col-lg3 layui-col-md3">
                                ...
                                <div class="layui-input-block">
                                    <select id="lazada_adjustpriceAndtpromotion_org" name="orgId"
                                            lay-filter="lazada_adjustpriceAndtpromotion_org" class="orgs_hp_custom">
                                    </select>
                                </div>
                            </div>
                            <div class="layui-col-lg3 layui-col-md3">
                                ...
                                <div class="layui-input-block">
                                    <select id="lazada_adjustpriceAndtpromotion_users" name="salePersonIds"
                                            lay-filter="lazada_adjustpriceAndtpromotion_users" class="users_hp_custom"
                            ...
                            <div class="layui-col-md3 layui-col-lg3">
                                ...
                                <div class="layui-input-block">
                                    <select id="lazada_adjustpriceAndtpromotion_store" name="storeAcctIdList"
                                ...
                                <div class="layui-col-md1 layui-col-lg1">
                                    <div class="layui-input-block">
                                        <button type="button" id="lazadapricenewPriceBtn"
                                ...
                                <div class="layui-col-md1 layui-col-lg1">
                                    <button class="layui-btn ml20 layui-btn-sm keyHandle" id=""
                                            lay-filter="lazadamodifypriceSearch" lay-submit="lazadamodifypriceSearch">计算
                                    </button>
...
<%--                                <div class="layui-col-md1 layui-col-lg1">--%>
<%--                                    <div class="layui-input-block">--%>
<%--                                    <button type="button" id="lazadapricebatchUpadatePrice"--%>
...
<%--                                </div></div>--%>
                            ...
                            <div class="layui-col-md2 layui-col-lg2">
                                ...
                                <div class="layui-input-block">
                                    <select id="adjustpriceAndpromotion_site_sel" lay-filter="adjustpriceAndpromotion_site_sel"
                                            xm-select="adjustpriceAndpromotion_site_sel" class="salesSiteList" name="salesSiteList" xm-select-search
                                            xm-select-search-type="dl" xm-select-skin="normal"></select>
                                </div>
                            </div>
                            </div><div class="layui-form-item">
                                <div class="layui-col-md2 layui-col-lg2">
                                    <button class="layui-btn ml20 layui-btn-sm keyHandle" id="lazadamodifypriceSearch" lay-tips="查询所有符合条件的在线商品"
                                            lay-filter="lazadamodifypriceSearch" lay-submit="lazadamodifypriceSearch">查询
                                    </button>
                                    <a class="layui-btn ml20 layui-btn-sm" id="lazadamodifypriceFilter" lay-tips="筛选当前页符合条件商品">筛选</a>
            ...
            <div class="layui-card">
                <div class="layui-card-header" style="display:flex;justify-content:space-between;">
                    <span>数量(<span id="lazadapriceNum"></span>)</span>
                    <button type="button" id="lazadapricebatchUpadatePrice" class="fr layui-btn layui-btn-normal layui-btn-sm">批量调价</button>
                </div>
                <div class="layui-card-body">
                    <!-- 表格的数据渲染 -->
                    <table class="layui-table" id="lazadamodifypricetable" lay-filter="lazadamodifypricetable"></table>
                    <script type="text/html" id="lazada_newprice">
                        <input type="number" class="layui-input newprice" name="newprice{{d.id}}" style="height:28px"
                               value="{{d.newPrice||d.price}}">
                    </script>
                     <script type="text/html" id="lazada_sales">
                        {{d.sevenSales||0}}/{{d.thirtySales||0}}/{{d.sixtySales||0}}/{{d.ninetySales||0}}/{{d.hundredOfEightySales||0}}
                     </script>
                    <script type="text/html" id="lazada_newSpecialprice">
                        <input type="number" class="layui-input newSpecialprice" name="newSpecialprice{{d.id}}"
                               value="{{d.newSpecialPrice||d.specialPrice}}" style="height:28px" data-specialPrice="{{d.specialPrice}}"  onblur="lazadaOnline_adjustpriceAndPro(this)">
                    </script>
                    <script type="text/html" id="lazada_specialPriceDiffPercent">
...
<script type="text/javascript" src="${ctx}/static/js/publishs/lazada/adjustpriceAndpromotion.js"></script>
<script>
    //多选渲染函数
