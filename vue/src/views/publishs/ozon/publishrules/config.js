...
export const ORDER_FIELD = [
  ...
  { label: '基础模板7天销量倒序', value: 3 },
  { label: '基础模板30天销量倒序', value: 4 },
  // { label: 'Lazada7天销量倒序', value: 5 },
  // { label: 'Lazada30天销量倒序', value: 6 },
  // { label: 'Shopee7天销量倒序', value: 7 },
  // { label: 'Shopee30天销量倒序', value: 8 },
  { label: '全平台俄罗斯30天销量倒序', value: 5 },
  { label: '全平台俄罗斯7天销量倒序', value: 6 }
];
