...
layui.define(["jquery"], function (exports) {
  ...
  Node.prototype = {
    ...
    init: function () {
      ...
      this.$li = $('<li role="menuitem" id="cascader-menu" tabindex="-1" class="el-cascader-node" aria-haspopup="true"><span class="el-cascader-node__label">' + label + '</span><i class="' + fromIcon + ' ' + icon + '"></i></li>');
