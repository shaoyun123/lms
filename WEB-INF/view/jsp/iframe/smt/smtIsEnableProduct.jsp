...
<div class="layui-fluid" id="smtIsEnableProduct">
                    ...
                    <form id="smt_theShelves_searchForm" lay-filter="prod_search_form" class="layui-form">
                        <div class="layui-form-item" style="margin-bottom:0">
                            <%--<div class="layui-col-lg1 layui-col-md1">--%>
                                    <%--<select id="smtProdSales_is_pAnds_sku">--%>
                            ...
                            <div class="layui-col-lg2 layui-col-md2" style="text-align:right">
                                        <button class="layui-btn layui-btn-sm keyHandle" type="button" data-type="reload" id="smtIsEnableProductSearchBtn">搜索</button>
                                        <button type="reset" class="layui-btn layui-btn-primary layui-btn-sm" id="smtIsEnableProductResetBtn">清空</button>
                            </div>
                        </div>
                        <div id="smtIsEnableProductCustomsContent"></div>
                    </form>
                </div>
            </div>
            <div class="layui-card">
                <div class="dis_flex layui-card-body">
                <div class="w_100 numCount" style="text-align:center;padding:0 5px;">数量(<span id="tolnum_span_smt_stop"></span>)</div>
                <div class="dis_flex mg_10">
                        <button type="button" id="smt_batchDisEnableProd" class="layui-btn layui-btn-danger layui-btn-sm">批量下架</button>
                    </div>
                </div>
                <div class="layui-card-body">
                    <!-- 表格的数据渲染 -->
...
<script type="text/javascript" src="${ctx}/static/js/publishs/aliexpress/smtIsEnableProduct.js"></script>
