...
<%--                                <button class="layui-btn ml20 layui-btn-sm keyHandle" type="button" data-type="reload" id="planeDict_searchBtn_deprecated">搜索--%>
<%--                                </button>--%>
...
<%--                    <select name="headCode" lay-filter="headCode" id="dictHeadSel">--%>
