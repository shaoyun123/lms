...
<div class="layui-fluid" id="LAY-AmazonFollowSellPlan">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-lg12 layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form" id="AmazonFollowSellPlanForm" lay-filter="AmazonFollowSellPlanForm">
                            ...
                            <div class="layui-col-lg2 layui-col-md2">
                                <div class="layui-input-block">
                                    <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" lay-submit=""
                                            id="AmazonFollowSellPlanSearch" lay-filter="AmazonFollowSellPlanSearch">查询
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    <div style="width:100%;height:30px;line-height:30px">
                        <div class="deliveryBtn">
                            <button type="button"
                                    class="layui-btn layui-btn-normal layui-btn-sm fr" id="AmazonFollowSellPlan_btn_createPlan">
                                创建跟卖计划
                            </button>
                        </div>
                    </div>

                    <table lay-filter="AmazonFollowSellPlan_table" class="layui-table"
                           id="AmazonFollowSellPlan_table"></table>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="AmazonFollowSellPlan_Time_tpl">
...
<script type="text/html" id="AmazonFollowSellPlan_status_tpl">
    {{#  if(d.status){ }}
...
<script type="text/html" id="AmazonFollowSellPlan_planInfo_tpl">
...
<script type="text/html" id="AmazonFollowSellPlan_op">
    <button class="layui-btn layui-btn-xs layui-btn-danger" lay-event="AmazonFollowSellPlan_event_edit">编辑</button>
    {{#  if(d.status){ }}
    <button class="layui-btn layui-btn-xs" lay-event="AmazonFollowSellPlan_event_close">停用</button>
    {{# }else{   }}
    <button class="layui-btn layui-btn-xs" lay-event="AmazonFollowSellPlan_event_open">启用</button>
    {{# }  }}
    <button class="layui-btn layui-btn-xs layui-btn-danger" lay-event="AmazonFollowSellPlan_event_delete">删除</button>
</script>

<script type="text/html" id="AmazonFollowSellPlan_layer">
    <form class="layui-form" id="editAmazonFollowSellPlanForm" lay-filter="editAmazonFollowSellPlanForm">
        <input class="disN" name="id" type="number">
        <div class="layui-form-item">
            <div class="layui-col-lg2 layui-col-md2">
                    <label class="layui-form-label">计划名称</label>
                <div class="layui-input-block">
        ...
        <button type="button" class="disN" lay-submit=""
                id="editAmazonFollowSellPlanSubmit" lay-filter="editAmazonFollowSellPlanSubmit">提交
        </button>
    </form>
</script>

<script src="/lms/static/js/publishs/amazon/followSellPlan.js"></script>