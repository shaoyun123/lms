    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
                    ...
                    <form id="adjustPriceSearchForm" class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <%--<div class="layui-col-md1 layui-col-lg1">--%>
                                <%--<select id="joom_idEnable_skuSearchType">--%>
            ...
            <div class="layui-card">
                ...
                <div class="numCount w_8" style="text-align:center;padding:0 5px;">数量(<span id="tolnum_span_wish_stop"></span>)</div>
                <div class="dis_flex w_90">
                        <button type="button" id="batchEnableProd" class="layui-btn layui-btn-normal layui-btn-sm">批量上架</button>
                        <button type="button" id="joom_batchDisEnableProd" class="layui-btn layui-btn-danger layui-btn-sm">批量下架</button>
                </div>
                </div>
                <div class="layui-card-body">
                    <!-- 表格的数据渲染 -->
...
<script type="text/javascript" src="${ctx}/static/js/publishs/joom/isEnableProduct.js"></script>
<script>
    //多选渲染函数
