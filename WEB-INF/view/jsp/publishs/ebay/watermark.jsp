    ...
    <div class="layui-col-space15">
        <div class="layui-card">
            <div class="layui-card-body">
                <form class="layui-form" id="watermarkForm">
                    <div class="layui-form-item layui-row">
                        ...
                        <div class="layui-col-lg3 layui-col-md3">
                            ...
                            <div class="layui-input-block">
                                <select lay-search lay-filter="watermark_online_salesman_sel" class="users_hp_custom"  data-rolelist="ebay专员" name="salePersonId">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
                        <div class="layui-col-lg3 layui-col-md3">
                            ...
                            <div class="layui-input-block">
                                <select lay-filter="watermark_search-store" class="store_hp_custom" name="storeAcctId" data-platcode="ebay" lay-search></select>
                            </div>
                        </div>
                        <div class="layui-col-lg3 layui-col-md3 pl20">
                            <span class="layui-btn layui-btn-sm"  lay-submit lay-filter="watermark_submit" id="watermark_submit">查询</span>
        ...
        <div class="layui-card">
            <div class="layui-card-header">
                <button class="layui-btn layui-btn-sm layui-btn-normal" type='button' id="watermark_newAdd">新增</button>
            </div>
            <div class="layui-card-body">
                <table class="layui-table layui-hide" id="watermark_table" lay-filter="watermark_tableFilter"></table>
            </div>
        </div>
    </div>
</div>
...
<%-- 表格操作列 --%>
<script type="text/html" id="watermark_tableIdBar">
   <a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
   <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="del">删除</a>
</script>
<%-- 水印类型 --%>
<script type="text/html" id="watermark_tableType">
   <div>
...
<%-- 水印显示方式 --%>
<script type="text/html" id="watermark_tableShow">
   <div>
        {{# if(d.watermarkType==0){ }}
        <span>
...
<%-- 新增水印弹框 --%>
<script type="text/html" id="watermark_newAddLayer">
    <div class="watermark">
        <%-- 尺寸切换 --%>
        <div class="layui-form watermark_sizeChangeClass">
            <select lay-filter="watermark_sizeChange">
        ...
        <div class="watermark-left">
           <form class="layui-form">
                ...
                <div class="layui-form-item watermarkTypeImg">
                    ...
                    <div class="layui-input-block">
						<button type="button" class="layui-btn layui-btn-xs" id="watermark_upload">上传图片</button>
                        <div class="layui-upload-list">
                            <img class="layui-upload-img" id="watermark_uploadImg" width="100" height="100" style="border: 1px solid #eee;">
                            <p id="watermark_uploadText"></p>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item watermarkTypeImg">
                    ...
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeImg_opacityAmount">0%</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min2">
                ...
                <div class="layui-form-item watermarkTypeImg">
                    ...
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeImg_sizeAmount">100%</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min1">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
                    </div>
                ...
                <div class="layui-form-item watermarkTypeImg">
                    ...
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeImg_rotateAmount">0</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min4">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
                    </div>
                ...
                <div class="layui-form-item watermarkTypeText disN">
                    ...
                    <div class="layui-input-block">
                        <select name="watermarkFontType" lay-filter="watermarkFontTypeF">
                ...
                <div class="layui-form-item watermarkTypeText disN">
                    ...
                    <div class="layui-input-block">
                        <select name="watermarkFontSize" lay-filter="watermarkFontSizeF">
                ...
                <div class="layui-form-item watermarkTypeText disN">
                    <label class="layui-form-label">透明度</label>
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeFont_opacityAmount">0%</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min3">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
                    </div>
                ...
                <div class="layui-form-item watermarkTypeText disN">
                    ...
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeFont_rotateAmount">0</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min5">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
                    </div>
                ...
                <%-- 水印图片旋转角度end --%>
                 <span class="layui-btn layui-btn-sm disN"  lay-submit lay-filter="watermarkAdd_submit">查询</span>
           </form>
        </div>
        <div class="watermark-right watermark-right-1000" id="watermark_rightBody">
            <div class="product-info-module watermark-right-modal f-left relative" id="albumListBody">
                <%-- 图片水印 --%>
                <div class="watermark-div" id="watermarkImageDiv">
                    <div class="watermark-div-fix"></div>
                    <img class="watermark-div-img" src="">
                </div>
                <%-- 文字水印 --%>
                <div class="watermark-font-div disN" id="watermarkFontDiv">
                    <span></span>
                </div>
            </div>
        </div>
...
<%-- 编辑水印弹框 --%>
<script type="text/html" id="watermark_editLayer">
    <div class="watermark" id="watermark_content">
    </div>
</script>
<%-- 编辑水印模板 --%>
<script type="text/html" id="watermark_contentTpl">
    <%-- 尺寸切换 --%>
    <div class="layui-form watermark_sizeChangeClass">
        <select lay-filter="watermark_sizeChange">
   ...
   <div class="watermark-left">
           <form class="layui-form">
                ...
                <div class="layui-form-item watermarkTypeImg">
                    ...
                    <div class="layui-input-block">
						<button type="button" class="layui-btn layui-btn-xs" id="watermark_upload">上传图片</button>
                        <div class="layui-upload-list">
                            <img class="layui-upload-img" id="watermark_uploadImg" width="100" height="100" style="border: 1px solid #eee;" src="{{d.watermarkUrl}}">
                            <p id="watermark_uploadText"></p>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item watermarkTypeImg">
                    <label class="layui-form-label">透明度</label>
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeImg_opacityAmount">{{d.watermarkTransparency}}%</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min2">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
                ...
                <div class="layui-form-item watermarkTypeImg">
                    <label class="layui-form-label">大小</label>
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeImg_sizeAmount">{{d.watermarkSize}}%</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min1">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
                ...
                <div class="layui-form-item watermarkTypeImg">
                    <label class="layui-form-label">旋转角度</label>
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeImg_rotateAmount">{{d.degree}}</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min4">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
                ...
                <div class="layui-form-item watermarkTypeText">
                    <label class="layui-form-label">文字旋转</label>
                    <div class="layui-input-block">
                        <div class="pull-right gray-c" id="watermarkTypeFont_rotateAmount">{{d.degree}}</div>
						<div class="w250 v-top m-top10 m-bottom20 ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="slider-range-min5">
                            <div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div>
                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 44.4444%;"></span>
                        </div>
        ...
        <div class="watermark-right watermark-right-1000" id="watermark_rightBody">
        {{# }else{ }}
        <div class="watermark-right watermark-right-800" id="watermark_rightBody">
        {{# } }}
            <div class="product-info-module watermark-right-modal f-left relative" id="albumListBody">
                {{# if(d.watermarkType == 0){ }}
                <%-- 图片水印 --%>
                <div class="watermark-div" id="watermarkImageDiv" style="position:absolute;border: 1px dashed gainsboro;cursor: all-scroll;left:{{d.left}}; top: {{d.top}};opacity: {{d.opacity}};transform: rotate({{d.degree}}deg)">
                    <div class="watermark-div-fix"></div>
                ...
                {{# }else{ }}
                <%-- 图片水印 --%>
                <div class="watermark-div disN" id="watermarkImageDiv">
                    <div class="watermark-div-fix"></div>
                    <img class="watermark-div-img" src="{{d.watermarkUrl}}">
                </div>
                <%-- 文字水印 --%>
                <div class="watermark-font-div" id="watermarkFontDiv" style="position:absolute;border: 1px dashed #ccc;cursor:all-scroll;left:{{d.left}}; top: {{d.top}};right: auto;bottom: auto;opacity: {{d.opacity}};background-color: {{d.watermarkFontBackgroundColor}};;transform: rotate({{d.degree}}deg)">
...
<script src="${ctx}/static/js/publishs/ebay/watermark.js"></script>
